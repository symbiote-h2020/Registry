...
Initiates connection with Rabbit server using parameters taken from Config\+Properties
...
Method creates channel and declares Rabbit exchanges for Platform and Resources. It requires active connection to Rabbit server. It triggers start of all consumers used in Registry communication. 
